...
class Database:
    ...
    def make_database(self):
        ...
        if path.exists(self.save_filepath):
            logging.info(f"Database already exists at: {self.save_filepath}")
            return True
        else:
            logging.info(f"Creating database at: {self.save_filepath}")
    ...
    def to_dict(self):
        ...
        dict_out["uncollected"] = [
            ...
            if prod.data_collected is False
        ]
        return dict_out
    ...
    def write_to_db(self):
        ...
        new_db = {"collected": new_db_c, "uncollected": new_db_uc}
    ...
    def get_products(self, soup: bs4.BeautifulSoup):
        ...
        logging.info(f"{len(self.products)} GPUs found")
    ...
    def filter_products(self, accepted_substrings: list):
        ...
        logging.info(f"{len(self.products)} GPUs to scrape")
